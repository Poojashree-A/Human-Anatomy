...
void frontscreen(void)
{
 ...
 glColor3f(0,0,1);
 drawstring(-15,40,0.0,"CITY ENGINEERING COLLEGE");
 glColor3f(0.7,0,1);
 drawstring(-30,33,0.0,"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
 glColor3f(1,0.5,0);
 drawstring(-10,25,0.0,"A MINI PROJECT ON ");
 glColor3f(1,0,0);
 drawstring(-25,20,0.0,"HUMAN DIGESTIVE AND RESPIRATORY SYSTEM");
 glColor3f(1,0.5,0);
 drawstring(-35,0,0.0,"BY:");
 glColor3f(0.5,0,0.5);
 drawstring(-35,-8,0.0,"POOJASHREE A (1CE17CS085)");
 drawstring(-35,-13,0.0,"SANJANA R (1CE17CS109)");
 strflag=0;
 drawstring(-35,-20,0.0,"6th Semester,CSE");
 glColor3f(1,0.5,0);
 drawstring(15,0,0.0,"GUIDE:");
 glColor3f(0.5,0.2,0.2);
 drawstring(15,-8,0.0,"RAMESH B");
 strflag=0;
 drawstring(15,-12,0.0,"Assistant Professor,CSE");
 glColor3f(1,0.1,1);
...
strflag=0;
glColor3f(0,0,0);
drawstring1(-10,10,0.0,"the waste water filtered by our kidneys becomes urine. Urine leaves the  ");
drawstring1(-16,8,0.0,"kidneys through two tubes called ureters. The ureters' job is to transport urine from  ");
drawstring1(-16,6,0.0,"the kidneys to the bladder, which is the temporary storage organfor urine.");
}
